...
Updated: 2026-09-22 (generation 17; batch 20260922-aftermerge; 60 executable cards: To Do 47, In Progress 3, Done 10; 13 summary parents excluded). Status, completion evidence and unique force rank are owned by [Kanban](kanban.md); entries retain that order. Explicit same-root Purple/Silver/Gold batch2 startup follows g16 quiescence/releases; earlier authorization and evidence dates remain preserved below. Purple EXR-004, Silver EXR-010-A02, Gold EXR-010-A03 are In Progress; respective queues EXR-011-A02, EXR-011-A03, EXR-007-A01 remain To Do. Three queued/44 unreserved. Only registry-named test-author files writable; implementation pending, Common unassigned/read-only, reviewers read-only. All phases/commands serial, no nested spawn, unique worker-reported TEMP GUID/output per invocation. No new Done, fresh full result, external readiness or autonomous background work claimed; offline acceptance is not live acceptance.
...
- Dependencies: EXR-001 (reclosed Done). Owner: Cohort Purple / f587f950-d93e-44ac-afcc-20bfb37576b9/Purple/batch2. Workstream: Change safety. Updated: 2026-09-22. Status: In Progress (g17 tests-first repair; historical completion below).
...
- Dependencies: EXR-001, EXR-005, EXR-010-A01 (Done). Owner: Cohort Silver / f587f950-d93e-44ac-afcc-20bfb37576b9/Silver/batch2. Workstream: Email protection. Updated: 2026-09-22. Status: In Progress (g17 tests first).
...
- Dependencies: EXR-001, EXR-005, EXR-010-A01 (Done). Owner: Cohort Gold / f587f950-d93e-44ac-afcc-20bfb37576b9/Gold/batch2. Workstream: Email protection. Updated: 2026-09-22. Status: In Progress (g17 tests first).
