...
Updated: 2026-09-24 (generation 25; 60 executable cards: To Do 46, In Progress 3, Done 11; 13 summary parents excluded). Status/evidence/rank owned by [Kanban](kanban.md). EXR-004 is bounded Done; Purple EXR-010-A08, Silver EXR-010-A02 and Gold EXR-010-A03 are In Progress. Queues EXR-011-A02, EXR-011-A03 and EXR-007-A01 remain To Do, 3 queued/43 unreserved. [Generation 25](cohorts.md#generation-25-closure-rebalance-and-bounded-grants) supersedes all prior grants: Silver/Coworker-2 has a one-file mapping grant, then Purple/Coworker-3 has read-only TABL assessment. Gold remains waiting for an explicit fail-closed versus EOP-only oracle; no Common/test repair or attempt-limit exception is authorized. The current full suite is red; no full-green, external-readiness or prior-grant revival claim.
...
Each source ID and assessment ID below resolves to the exact URL, section, review date, applicability, license and dated Gap/Partial assessment in the linked inventory. Merged identifies the delivery owner; statuses and ranks below are current, not the original proposal snapshot. EXR-009 merges are complete for offline acceptance; EXR-010/011 and split EXR-007 proposals resolve to named executable leaves through non-executable parents. EXR-010-A01 and EXR-011-A01 are Done for bounded offline acceptance; EXR-010-A02/A03 are In Progress at g17, other siblings To Do, neither parent Done. Proposal count remains fifteen. Decomposition redistributes existing acceptance, not newly discovered recommendations; proposal statuses/ranks in the product inventory remain the dated snapshot, not delivery status.
...
| EXR007-C10 | A08 / S14, S10, S13 | Decomposed through [EXR-010](#acceptance-allocation): A01-A07 (ranks 10-16), A11-A12 (ranks 20-21); A01 Done (bounded offline), A02/A03 In Progress, others To Do | Catalogue, effective scope, entitlement and supported changes have distinct child owners; parent is not executable or counted. |
...
All children: parent EXR-010; scope Exchange recipients only; source/control/evidence/runbook mapping must be updated for the touched contract before closure. A01 Done at g16; A02/A03 In Progress for Silver/Gold batch2 at g17, A04-A12 unassigned To Do. Named worker invocation is authorized only within registry phases/paths, not for this parent or all children. Historical tests at checkpoint 0269862 are not current child acceptance.
...
- Dependencies: EXR-001, EXR-005, EXR-010-A01 (Done). Owner: Cohort Silver / f587f950-d93e-44ac-afcc-20bfb37576b9/Silver/batch2. Workstream: Email protection. Updated: 2026-09-24. Status: In Progress (g25 mapping grant completed, exhausted and released; incomplete command-set assertion, precedence ambiguity and Common/test follow-up remain ungranted).
...
- Dependencies: EXR-001, EXR-005, EXR-010-A01 (Done). Owner: Cohort Gold / f587f950-d93e-44ac-afcc-20bfb37576b9/Gold/batch2. Workstream: Email protection. Updated: 2026-09-24. Status: In Progress (g24 waiting on root/user oracle; stopped at Common attempt limit; three matrix regressions and review blockers open).
...
- Dependencies: EXR-004, EXR-005 (Done). Owner: Cohort Purple / f587f950-d93e-44ac-afcc-20bfb37576b9/Purple/batch2. Workstream: Email protection. Updated: 2026-09-24. Status: In Progress (g25 force-rank claim; read-only acceptance assessment first).
